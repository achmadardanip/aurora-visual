...
const data={case_id:b.case_id,claim_revision:b.claim_revision,claim_text_sha256:crypto.createHash('sha256').update(b.input.claim_text).digest('hex'),image_sha256_list:b.input.images.map(m=>m.sha256).sort(),atomic_claims:atoms};
